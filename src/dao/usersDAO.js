...
export default class UsersDAO {
  ...
  static async getUser(email) {
    // Ticket: User Management - Retrieve the user document corresponding with the user's email.
  ...
  static async addUser(userInfo) {
    // Ticket: User Management - Insert a user with the "name", "email", and "password" fields.
    // Ticket: Durable Writes - Use a more durable Write Concern for this operation. increase the durability of this method by using a non-default write concern with ``insertOne``.
    try {
  ...
  static async loginUser(email, jwt) {
    try {
      // Ticket: User Management - Use an UPSERT statement to update the "jwt" field in the document,
  ...
  static async logoutUser(email) {
    try {
      // Ticket: User Management - Delete the document in the `sessions` collection matching the email.
  ...
  static async getUserSession(email) {
    try {
      // Ticket: User Management - Retrieve the session document corresponding with the user's email.
