...
export default class CommentsDAO {
  ...
  */
  ...
  static async mostActiveCommenters() {
    ...
    */
    try {
      // Ticket: User Report - Return the 20 users who have commented the most on MFlix.
      const pipeline = [
        {
          $group: {
            _id: "$email",
      ...
      const readConcern = "majority" // Ticket: User Report - Use a more durable Read Concern here to make sure this data is not stale.
